...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "   This can be either:\n"
            "   - a string, the *model id* of a pretrained model hosted inside a model repo on huggingface.co, e.g., `robotics-diffusion-transformer/hrdt-1b`,\n"
            "   - a path to a *directory* containing model weights saved using [`~HRDTRunner.save_pretrained`] method, e.g., `./my_model_directory/`.\n"
